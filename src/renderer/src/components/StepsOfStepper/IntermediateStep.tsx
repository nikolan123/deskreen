        ...
        <>
          <Row center="xs">
            <div style={{ marginBottom: '10px' }}>
              <Text>{t('choose-entire-screen-or-app-window-you-want-to-share')}</Text>
            </div>
          </Row>
...
export default function IntermediateStep(props: IntermediateStepProps): React.ReactElement {
