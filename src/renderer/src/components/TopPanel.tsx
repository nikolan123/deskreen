...
export default function TopPanel({ handleReset }: Props): React.ReactElement {
  ...
  const renderHelpButton = (
    <div className={classes.topPanelControlButtonMargin}>
      <Tooltip content={t('fix-reset-tooltip')} position={Position.BOTTOM}>
        ...
        >
          <Icon className={classes.topPanelIconOfControlButton} icon="lifesaver" size={22} />
        </Button>
      </Tooltip>
    </div>
  );
    ...
    <div className={classes.topPanelControlButtonMargin}>
      <Tooltip content={t('settings')} position={Position.BOTTOM}>
        <Button
          ...
          className={classes.topPanelControlButton}
        >
          <Icon className={classes.topPanelIconOfControlButton} icon="cog" size={22} />
        </Button>
      </Tooltip>
    </div>
  );
  ...
  const renderLogoWithAppName = (
    <div id="logo-with-popover-visit-website" className={classes.logoWithAppName}>
  ...
  return (
    <>
      ...
      {isSettingsOpen ? (
        <SettingsOverlay isSettingsOpen={isSettingsOpen} handleClose={handleSettingsClose} />
      ) : (
        <></>
      )}
      {isConnectedDevicesDrawerOpen ? (
